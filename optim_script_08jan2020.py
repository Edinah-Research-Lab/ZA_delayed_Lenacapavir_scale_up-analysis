...
BASE_POPULATION_SCALE_FACTOR = 0.0005 # For quick test simulations, this is set to a very low value
N_ITERATIONS = 2
...
ingest_xlsm_filename = os.path.join('Data', 'calibration_ingest_form-SouthAfrica_07jan.xlsm')
